            ...
            <div class="content">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-header card-header-primary" style="background: #6262ff;">
                                    <h4 class="card-title">Employee Payment</h4>
                                ...
                                <div class="card-body">
                                    <form id="payment_form">
                                         ...
                                         <div class="col-md-6">
                                              <div class="form-group">
                                                  <p>Address - <b><span id="address"></span></b></p>  
                                                  <p>Phone No - <b><span id="phoneNo"></span></b></p>  
                                              </div>
                                        ...
                                        <button type="submit"  class="btn btn-primary pull-right" style="background-color: #6262ff;">Add Data</button>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header card-header-primary" style="background: #6262ff;">
                                    <h4 class="card-title ">Employee Payment  Table</h4>
                                    <p class="card-category"> Here is a subtitle for this table</p>
                                </div>
                                <div class="card-body">
                                   <?php
                                       $query = "SELECT A.p_id , B.name AS ename , A.amount , A.description ,A.date FROM  payment A  INNER JOIN employee B ON A.emp_id = B.id;";
                                       $result = mysqli_query($conn ,$query);
   ...
   //Payment Item Form
    ...
    $('#payment_form').on('submit', function (e) {
      e.preventDefault();
          ...
          $.ajax({
            type: 'post',
            url: '../controller/controller_payment.php',

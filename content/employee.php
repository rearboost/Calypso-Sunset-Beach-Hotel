                    ...
                    <div class="row">
                                    ...
                                    <form id="employee_form">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <?php
                                                        ...
                                                        $nextID = sprintf('EMP-%05d', $nextID);
                                                        echo '<input type="hidden" name="emp_id" id="emp_id" value='.$nextID.'>';
                                         ...
                                         <div class="row">
                                          <div class="col-md-6">
                                              <div class="form-group">
                                                  <label class="bmd-label-floating">Designation<span style="color: red;"> *<span></label>
                                                  <!-- <input type="text" class="form-control" id="alocatedroom"> -->
                                                  <select  class="form-control" id="des_id" name="des_id" required>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="bmd-label-floating">Employee name<span style="color: red;"> *<span></label>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label class="bmd-label-floating">Phone No <span style="color: red;"> *<span></label>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                     <label class="bmd-label-floating" style="top: -1rem; left: 0; font-size: 0.6875rem;">Join Date</label>
                                                    <input type="date" name="join_date" class="form-control" value='<?php echo date('Y-m-d'); ?>'  id="join_date">
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                   <?php
                                       $query = "SELECT A.emp_id , B.name AS dname , A.name , A.address ,A.phoneNo ,A.join_date FROM employee A  INNER JOIN designation B ON A.des_id = B.id;";
                                       $result = mysqli_query($conn ,$query);
                                    ?>
   ...
   //Employee Form
    ...
    $('#employee_form').on('submit', function (e) {
      e.preventDefault();
          ...
          $.ajax({
            type: 'post',
            url: '../controller/controller_employee.php',

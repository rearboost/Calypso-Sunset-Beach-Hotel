                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-header card-header-primary">
                                    <h4 class="card-title">Create Bar Recipe</h4>
                                    <p class="card-category">Add/Update recipe detalis</p>
                                </div>
                                <div class="card-body">
                                    <form id="assign_form">
                                         <div class="row">
                                          <div class="col-md-6">    
                                              <div class="form-group">
                                                   <label class="bmd-label-floating">Recipe Name<span style="color: red;">*<span></label>
                                          ...
                                          <div class="col-md-6">
                                              <div class="form-group">
                                                 ...
                                                 <select  class="form-control" id="item_id" name="item_id" required>
                                                          ...
                                                          {
                                                              echo "<option value='".$row['id']."'>".$row['lq_name']."</option>";
                                                          }
                                                         ?>
                                                </select> 
                                              </div>
   ...
   //Assign Item Form
    ...
    $('#assign_form').on('submit', function (e) {
      e.preventDefault();
          ...
          $.ajax({
            type: 'post',
            url: '../controller/controller_bar_recepie.php',
